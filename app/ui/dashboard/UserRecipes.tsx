                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <div className="mb-2 flex items-center">
                                    <p className="font-bold"><Link href={`/recipes/${meal.id}/`} target="_blank" className="underline text-white-700">{meal.name}</Link></p>
                                </div>
                ...
                <table className="hidden min-w-full text-gray-900 md:table cursor-pointer">
                    ...
                    {userMeals?.map((meal) => (
                        ...
                        <td className="whitespace-nowrap py-3 pl-6 pr-3">
                            <Link href={`/recipes/${meal.id}/`} target="_blank" className="underline text-white-700"><span className="font-bold">{meal.name}</span></Link>
                        </td>
