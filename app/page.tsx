    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
      ...
      <div className="w-full bg-white ">
        <div className="container mx-auto px-6 py-16 text-center">
          ...
          <Link href="#" className="inline-block mt-3 text-mallard-500 border border-white-200 bg-white-50 px-6 py-3 rounded-md text-lg font-medium hover:bg-mallard-100 hover:text-white-500">
              Example Link
          </Link>
        </div>
      </div>
